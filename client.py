#This was FTX's api client from their github with some tweaks by me circa early 2021. Should still work, if the site ever comes online again. 
import time
import urllib.parse
...
class FtxClient:
    ...
    def get_fills(self,start_time: float, end_time: float) -> List[dict]:
        return self._get(f'fills?limit=5000&order="asc"&start_time={start_time}&end_time={end_time}')
